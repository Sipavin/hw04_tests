# Generated by Django 2.2.16 on 2022-05-22 20:05
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='post',
            name='text',
            field=models.TextField(help_text='Напишите текст поста', validators=[posts.utilits.validate_not_empty], verbose_name='Текст поста'),
        ),
    ]
